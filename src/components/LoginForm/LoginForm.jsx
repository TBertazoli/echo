  ...
  return (
    <div>
      <div className="w-full mx-auto flex justify-center items-center h-full">
        <form
          className="relative h-full rounded-xl bg-white shadow-[0px_0px_0px_1px_rgba(9,9,11,0.07),0px_2px_2px_0px_rgba(9,9,11,0.05)] dark:bg-zinc-900 dark:shadow-[0px_0px_0px_1px_rgba(255,255,255,0.1)] dark:before:pointer-events-none dark:before:absolute dark:before:-inset-px dark:before:rounded-xl dark:before:shadow-[0px_2px_8px_0px_rgba(0,_0,_0,_0.20),_0px_1px_0px_0px_rgba(255,_255,_255,_0.06)_inset] forced-colors:outline"
          autoComplete="off"
          onSubmit={handleSubmit}
          style={{ width: "500px" }}
        >
          <div className="grid h-full w-full overflow-hidden  p-6 py-8 sm:p-8 lg:p-12">
            <h3 className="text-lg/7 font-semibold tracking-[-0.015em] text-zinc-950 sm:text-base/7 dark:text-white text-left mb-4">
              Sign in
            </h3>
            ...
            <div className="flex flex-col justify-start ">
              <label className="select-none text-left text-base/6 text-zinc-950 data-[disabled]:opacity-50 sm:text-sm/6 dark:text-white mb-4">
                Email
              </label>
              <input
                type="text"
            ...
            <label className="mt-4 select-none text-left text-base/6 text-zinc-950 data-[disabled]:opacity-50 sm:text-sm/6 dark:text-white mb-4">
              Password
            </label>
            <input
              type="password"
            ...
            <p
              data-slot="text"
              class="text-base/6 mt-8 text-left text-zinc-500 sm:text-sm/6 dark:text-zinc-400"
            >
              Don’t have an account?{" "}
              <span
                onClick={() => setShowSignUp(true)}
                class="font-semibold text-zinc-950 hover:text-zinc-700 dark:text-white dark:hover:text-zinc-300 cursor-pointer"
              >
                Sign up
              </span>
            </p>
