  ...
  return (
    <div>
      <div className="w-full mx-auto flex justify-center items-center h-full">
        <form
          className="relative h-full rounded-xl  bg-zinc-900 shadow-[0px_0px_0px_1px_rgba(255,255,255,0.1)] before:pointer-events-none before:absolute before:-inset-px before:rounded-xl before:shadow-[0px_2px_8px_0px_rgba(0,_0,_0,_0.20),_0px_1px_0px_0px_rgba(255,_255,_255,_0.06)_inset] forced-colors:outline"
          autoComplete="off"
        ...
        >
          <div className="grid h-full w-full overflow-hidden  p-6 py-8 sm:p-8 lg:p-12">
            ...
            {
              disable && (<p className="text-red-500 text-sm">Passwords do not match</p>)
            }
            <button
            ...
            <p
              data-slot="text"
              class="text-base/6 mt-8 text-left sm:text-sm/6 text-zinc-400"
            >
